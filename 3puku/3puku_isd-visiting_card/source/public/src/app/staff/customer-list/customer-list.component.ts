...
import { StaffCustomerSearchService } from './searchService';
declare var $: any;
...
export class CustomerListComponent implements OnInit {
   ...
   // private pager = 1;
    ...
    constructor(private restfulService:RestfulService, private staffService:StaffService,private searchService: StaffCustomerSearchService) {
    }

    ngOnInit() {
        let data = {'store_id': this.staffService.getStoreID(),
