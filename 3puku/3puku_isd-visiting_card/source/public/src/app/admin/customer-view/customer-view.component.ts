...
export class AdminCustomerViewComponent implements OnInit {
  ...
  private myDatePickerOptions: IMyDpOptions = {
    ...
    getCustomerInfo(){
        ...
        let url = 'admin/customer/detail_list';
    ...
    updateStaffInCharge(comp){
        ...
        let url = 'admin/customer/staff_id';
